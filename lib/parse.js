...
function parseString(value, currentColor, currentHslColor, isHsl) {
...
function parseObject(value, currentColor, currentHslColor, isHsl) {
    var alpha, clonedValue = clone(value, parseFloat);
...
function parse(value, currentColor, currentHslColor, isHsl) {
    if (typeof value === 'string') {
        return parseString(value, currentColor, currentHslColor, isHsl);
        ...
        return parseObject(value, currentColor, currentHslColor, isHsl);
    }
    return {
        rgba: currentColor,
        hsla: currentHslColor,

...
var Color = (function (Math) {
    ...
    function Color(value) {
        ...
        self.getHslaString = function () {
            return getHslaString(currentHslColor);
        };
        self.getHslString = function () {
            return getHslString(currentHslColor);
        };
    ...
    function getRgbaString(color) {
        return 'rgba(' + round(color.r * 255) + ',' + round(color.g * 255) + ',' + round(color.b * 255) + ',' + round(color.a * 100) / 100  + ')';
    }
    ...
    function getHslString(hsla) {
        return 'hsl(' + round(hsla.h * 360) + ',' + round(hsla.s * 100) + '%,' + round(hsla.l * 100) + '%)';
    }
    function getHslaString(hsla) {
        return 'hsla(' + round(hsla.h * 360) + ',' + round(hsla.s * 100) + '%,' + round(hsla.l * 100) + '%,' + round(hsla.a * 100) / 100  + ')';
    }
